...
DATA_DIR = '/readonly/lsstdata/auxtel/base/auxtel/oods/butler/repo' # This is the data
parser = argparse.ArgumentParser()

parser.add_argument('--rerunDir', help='Where you want to put the output')
